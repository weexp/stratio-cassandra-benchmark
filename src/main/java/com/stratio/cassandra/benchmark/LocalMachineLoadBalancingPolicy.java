...
public class LocalMachineLoadBalancingPolicy extends RoundRobinPolicy {
	 ...
	 * <p/>
	 * This policy consider all nodes as local. This is generally the right thing to do in a single
	 * datacenter deployment. If you use multiple datacenter, see
	 * {@link com.datastax.driver.core.policies.DCAwareRoundRobinPolicy} instead.
	 * 
	 * @param host
	 ...
	 * <p/>
	 * The returned plan will try each known host of the cluster. Upon each call to this method, the
	 * {@code i}th host of the plans returned will cycle over all the hosts of the cluster in a
	 * round-robin fashion.
	 * 
